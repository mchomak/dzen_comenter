...
DEFAULT_ANTI_RULES = (
    ...
    "- выдумывать факты, если смысл комментария непонятен. В таком случае верни только SKIP."
)
DEFAULT_ANTI_RULES += (
    "\n- Не отвечай на темы: политика, власть, политические деятели, секс, "
    "наркотики, медицинские препараты, государственные органы, зарплаты, пенсии; "
    "верни только SKIP."
)

DEFAULT_TASK_LEAD = (
    "Ответь по сути комментария. Мягкий CTA допустим "
