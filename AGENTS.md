...
| Команда | Назначение |
|---|---|
| `/tmp/dzen-commenter-test.3icCmB/bin/pytest` | Полный тестовый набор: проверено, `383 passed, 25 skipped`. |
